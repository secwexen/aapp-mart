...
The system generates structured **attack-path reports**, **MITRE ATT&CK mapped insights**, and **dynamic risk scoring outputs** to support SOC operations, detection engineering, and continuous security improvement.
