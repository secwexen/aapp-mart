...
Centralized project documentation and technical references. This folder contains all guides, references, research, and legal documents for the project.
...
- `modules.md` – Module relationships

### 6. `concepts/`

Core concepts and AI agents:
...
- `prediction-engine.md` – Prediction engine details  
...
- `references.md` – Reference materials and resources
