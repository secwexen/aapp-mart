...
**AAPP‑MART** (AI‑Autonomous Attack Path Prediction & Multi‑Agent Red Team Simulation Engine) is an open‑source python cybersecurity and AI security engine for **offensive security**, **adversarial modeling**, **adversary emulation**, **security validation**, **threat modeling**, **cyber risk assessment**, and **automated risk assessment**. It combines **AI‑powered attack‑path prediction** with **autonomous multi‑agent red‑team simulation** to model how real attackers navigate an environment and to reveal actionable, data‑driven security insights.
